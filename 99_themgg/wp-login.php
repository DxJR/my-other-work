...
<?php
	...
	<style type="text/css">
	/* login */
	html body.login {background:#fc0 !important;}
	.login form {-webkit-box-shadow:none; box-shadow:none; border:0;}
	div#login h1 {display:none;}
	div#login form {-moz-box-shadow:none;; -webkit-box-shadow:none; box-shadow:none;}
	.login form {margin:0; padding:0; border:0; background:none;}
	</style>
</head>
<body class="login">
<script type="text/javascript">
//<![CDATA[
	var targetUrl = 'http://www.themgg.com/';
	var aboutUrl = 'http://www.themgg.com/about';
	var aboutEngUrl = 'http://www.themgg.com/abouteng';
	var aboutContactUrl = 'http://www.themgg.com/about#a_contact';
	var aboutEngContactUrl = 'http://www.themgg.com/abouteng#a_contact';
	var thisUrl = location.href;
	if (thisUrl==targetUrl) {
		document.body.setAttribute('id','index');
	}
	if (thisUrl==aboutUrl || thisUrl==aboutEngUrl || thisUrl==aboutContactUrl || thisUrl==aboutEngContactUrl) {
...
<div id="page" class="hfeed">
	<header id="branding" role="banner">
		<hgroup id="h1group">
			...
			<p class="gotohome"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home" target="_self"><span class="ir">Go to Home</span></a></p>
		</hgroup>
		<ul id="gnb">
			<li class="lb"><a href="/wp-login.php" class="gbtn signin"><span class="ir">SIGN IN</span></a></li>
			<li><a href="/wp-login.php?action=register" class="gbtn register"><span class="ir">REGISTER</span></a></li>
			<li class="lb line2"><a href="/about" class="gbtn about"><span class="ir">ABOUT</span></a></li>
			<li><a href="/about#a_contact" class="gbtn contact"><span class="ir">CONTACT</span></a></li>
		</ul>
...
<?php   if ( !is_multisite() ) { ?>
<div id="login">
	<div class="tit"><h2><span class="ir">SIGN IN/로그인</span></h2></div>
	<div class="login_wrap">
		<div class="login_in">
<?php   } else { ?>
<div id="login"><div class="tit"><h2><span class="ir">SIGN IN/로그인</span></h2></div>
	<div class="login_wrap">
		<div class="login_in">
<?php   }
...
<?php endif; ?>
			...
			<p class="eng">Welcome to visit my website the mgg.com.<br />If you are already a member, please log in. <br />If it is your first visit, please press register button.<br />Thank you.</p>
			<p class="kor">홈페이지에 방문해주셔서 감사합니다. 회원이신 분은 아이디와 패스워드로 로그인해주세요.<br />처음 방문하신 분은, 먼저 등록해주신 후 이용해주세요.<br />감사합니다.</p>
		</div></div>
